...
> **Read-only metadata**: `uniqueId`, `createdTime`, `lastEditedTime`, `createdBy`, and `lastEditedBy` are computed by Notion. Inserts/updates throw if you try to set them.
